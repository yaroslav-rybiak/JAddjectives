...
class Quiz {
    ...
    public static void main(String[] args) {
        ...
        while (!questionDictionary.isEmpty()) {
            Random rand = new Random();
            if(questionDictionary.size() > 1 && correctFlag) {
                randomIndex = rand.nextInt(questionDictionary.size());
            } else if(questionDictionary.size() == 1 && correctFlag) {
                randomIndex = 0;
            }
